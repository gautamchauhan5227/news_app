...
extension ArticleModelQuerySortBy
  ...
  QueryBuilder<ArticleModel, ArticleModel, QAfterSortBy> sortBySourceId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sourceId', Sort.asc);
    });
  }

  QueryBuilder<ArticleModel, ArticleModel, QAfterSortBy> sortBySourceIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sourceId', Sort.desc);
    });
  }

  QueryBuilder<ArticleModel, ArticleModel, QAfterSortBy> sortBySourceName() {
    return QueryBuilder.apply(this, (query) {
...
extension ArticleModelQuerySortThenBy
  ...
  QueryBuilder<ArticleModel, ArticleModel, QAfterSortBy> thenBySourceId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sourceId', Sort.asc);
    });
  }

  QueryBuilder<ArticleModel, ArticleModel, QAfterSortBy> thenBySourceIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sourceId', Sort.desc);
    });
  }

  QueryBuilder<ArticleModel, ArticleModel, QAfterSortBy> thenBySourceName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sourceName', Sort.asc);
    });
  }
...
extension ArticleModelQueryWhereDistinct
  ...
  QueryBuilder<ArticleModel, ArticleModel, QDistinct> distinctBySourceId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ArticleModel, ArticleModel, QDistinct> distinctBySourceName(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ArticleModelQueryProperty
  ...
  QueryBuilder<ArticleModel, String, QQueryOperations> sourceIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'sourceId');
    });
  }

  QueryBuilder<ArticleModel, String, QQueryOperations> sourceNameProperty() {
    return QueryBuilder.apply(this, (query) {
